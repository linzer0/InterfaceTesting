...
public class NewEditor : EditorWindow
{
    ...
    private TestReport[] _testObjects = new TestReport[]
    {
        new TestReport(0, "Hello", false, "Wow", null),
        new TestReport(1, "World", true, "Nor report", null),
        new TestReport(2, "Third", false, "aaa", null),
        new TestReport(3, "Lol", true, "1111", null),
        new TestReport(4, "Aello", false, "222222", null),
    };
    ...
    private void OnGUI()
    {
        ...
        for (int a = 0; a < this._testObjects.Length; a++)
        {
            ...
            if (this._multiColumnHeader.IsColumnVisible(columnIndex: columnIndex))
            {
                ...
                EditorGUI.LabelField(
                    position: this._multiColumnHeader.GetCellRect(visibleColumnIndex: visibleColumnIndex, columnRect),
                    this._testObjects[a].GetDescription());
            }
            ...
            if (this._multiColumnHeader.IsColumnVisible(columnIndex: columnIndex))
            {
                ...
                EditorGUI.LabelField(
                    this._multiColumnHeader.GetCellRect(visibleColumnIndex: visibleColumnIndex, columnRect),
                    _testObjects[a].GetTestStatus());
            }
        }
